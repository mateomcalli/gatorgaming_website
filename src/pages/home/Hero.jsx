  ...
  return (
    <div className='w-screen pt-20 md:justify-center flex z-2'>
      <div className='w-screen flex justify-between lg:items-center lg:w-3/4 lg:min-h-[calc(100vh-5rem)] z-2'>
        <div className='pl-6 pr-8 md:text-balance flex flex-col md:items-center md:text-center pt-10 pb-16 lg:text-left lg:items-start lg:w-2/3 lg:pl-20 lg:text-pretty z-2 font-display'>

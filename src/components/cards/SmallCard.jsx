  ...
  return (
    <div className='w-[265px] h-95 flex flex-col relative bg-black border-solid border-5 border-ggorange rounded-xl'>
      <div className='flex pb-1 justify-between pt-[3px] pl-[10px]'>
        ...
        <img className='pointer-events-none border-1 rounded-full border-ggwhite w-6.5 mr-2 mt-[1px]' src='gatorgaming-logo.png' alt='Gator Gaming logo'/>
      </div>
      ...
      <img className='pointer-events-none w-24 opacity-40 self-center -mt-11' src='gud-logo1.png' alt='Gator User Design logo'/>
    </div>
  )
}

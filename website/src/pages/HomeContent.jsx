...
const HomeContent = () => {
  return (
    <div className='justify-center flex z-2'>
      <div className='flex gap-15 w-2/3 h-screen z-1'>
        <div className='test-blue flex flex-col gap-8 w-1/2'>
          <img 
        ...
        <div className='test-blue flex pt-3 gap-13 flex-col w-1/2 z-1'>
          <div>

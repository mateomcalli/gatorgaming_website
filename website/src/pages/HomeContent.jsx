...
const HomeContent = () => {
  return (
    <div className='justify-center flex z-2'>
      <div className='grid grid-cols-2 grid-rows-[1fr_1fr] gap-x-15 gap-y-10 w-215 xl:w-315 2xl:w-332 h-screen z-1'>
        ...
        <div className='pl-10 justify-center flex flex-col z-1'>

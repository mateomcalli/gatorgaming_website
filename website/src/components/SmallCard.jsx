const SmallCard = ({ name, picture }) => {
  return (
    <div className='w-[265px] h-95 flex flex-col relative bg-black border-solid border-5 border-ggorange rounded-xl'>
      ...
      <img className='pointer-events-none mx-[8px] border-1 border-[#9F9F9F]' src='/people/mateo-m.png'/>
      <img className='pointer-events-none w-24 opacity-40 self-center mt-[38px]' src='gud-logo.png'/>
    </div>
  )
}
